...
abstract class $AuthenticatedUserCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String email, int id, String profileImage, String fullName, String bio});
}
...
class _$_AuthenticatedUser implements _AuthenticatedUser {
  ...
  @override
  String toString() {
    return 'AuthenticatedUser(email: $email, id: $id, profileImage: $profileImage, fullName: $fullName, bio: $bio)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, id, profileImage, fullName, bio);
...
abstract class _AuthenticatedUser implements AuthenticatedUser {
  const factory _AuthenticatedUser(
      ...
      final String profileImage,
      final String fullName,
      final String bio}) = _$_AuthenticatedUser;
